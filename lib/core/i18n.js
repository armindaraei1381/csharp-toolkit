...
const MESSAGES = {
  en: {
    ...
    'createProject.pickerTitle': 'Create a new .NET project',
    'createProject.pickerSubtitle': 'Powered by dotnet new · type to filter',
    'createProject.footerCount': '{shown} of {total} templates',
    'createProject.hintNavigate': 'Navigate',
    'createProject.hintSelect': 'Select',
    'createProject.hintCancel': 'Cancel',
    'createProject.noMatches': 'No matching template'
  },
  fa: {
    ...
    'createProject.pickerTitle': 'ساخت پروژه‌ی جدید دات‌نت',
    'createProject.pickerSubtitle': 'بر پایه‌ی dotnet new · برای فیلتر تایپ کنید',
    'createProject.footerCount': '{shown} از {total} تمپلیت',
    'createProject.hintNavigate': 'جابه‌جایی',
    'createProject.hintSelect': 'انتخاب',
    'createProject.hintCancel': 'انصراف',
    'createProject.noMatches': 'تمپلیتی پیدا نشد'
  }
};
