...
export default class NewFileCommand {
  ...
  get config() {
    return {
      namespaceStyle: atom.config.get(configKey('namespaceStyle')),
      enableNullable: atom.config.get(configKey('enableNullable')),
      interfacePrefix: atom.config.get(configKey('interfacePrefix')),
      braceStyle: atom.config.get(configKey('braceStyle')),
      testFramework: atom.config.get(configKey('testFramework'))
    };
  }
